...
import 'package:firstproject/domain/usecase/register_use_case.dart';
...
class RegisterViewModel extends BaseViewModel
  ...
  Stream<String?> get outputErrorUserName => outputIsUserNameValid
      .map((isUserName) => isUserName ? null : AppString.userNameInvalid);
  ...
  Stream<String?> get outputErrorMobileNumber =>
      outputIsMobileNumberValid.map((isMobileNumberValid) =>
          isMobileNumberValid ? null : AppString.mobileNumberInvalid);
  ...
  Stream<String?> get outputErrorPassword => outputIsPasswordValid.map(
      (isPasswordValid) => isPasswordValid ? null : AppString.passwordInvalid);
